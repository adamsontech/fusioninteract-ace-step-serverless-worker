...
def handler(job):
    ...
    try:
        ...
        payload = {
            ...
            "use_format": _bool(_get_ci(job_input, "use_format"), False),
            "thinking": _bool(_get_ci(job_input, "thinking"), _bool(os.environ.get("ACESTEP_DEFAULT_THINKING"), True)),
            "use_cot_caption": _bool(_get_ci(job_input, "use_cot_caption"), False),
            "use_cot_language": _bool(_get_ci(job_input, "use_cot_language"), False),
